...
class _HomeState extends State<Home> {
  ...
  String q2 = "Q2. Do you like working in a team or performing individually? Explain Why? ";
  String q3 =
      "Q3. When you encounter an unknown problem, do you rely on facts or try to generate new possibilities? Explain. ";
  String q4 = "Q4. You are assigned with difficult project with very short deadline, what will be your strategy?";
  String q5 =
  ...
  void get_personality() async {
    ...
    Map<String, dynamic> reponse = await PredictionAPIs.get_personality_type(answer);
    setState(() {
                  ...
                  ? Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("$q1", style: TextStyle(fontSize: 20, fontFamily: "Concert")),
                        ),
                        ...
                        Container(
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                                colors: [Color.fromARGB(255, 83, 69, 206), Color.fromARGB(255, 10, 33, 116)]),
                          ),
                          height: 44.0,
                      ...
                      SelectableText.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(text: 'type is: ', style: TextStyle(fontSize: 21, fontStyle: FontStyle.italic)),
                            TextSpan(
                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              ...
                              color: Colors.white,
                              gradient: LinearGradient(
                                  colors: [Color.fromARGB(255, 10, 33, 116), Color.fromARGB(255, 83, 69, 206)]),
                            ),
                            height: 44.0,
                            child: ElevatedButton(
                              onPressed: () {
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              color: Colors.white,
                              gradient: LinearGradient(
                                  colors: [Color.fromARGB(255, 32, 61, 108), Color.fromARGB(255, 49, 19, 80)]),
                            ),
                            height: 44.0,
                            child: ElevatedButton(
                              onPressed: () {
                        ...
                        Container(
                          ...
                          child: InteractiveViewer(
                            ...
                            child: CachedNetworkImage(
                                ...
                                imageUrl: "https://predictpersonality.herokuapp.com/accuracy/image?image_name=accuracy",
                                placeholder: (context, url) => Center(child: CircularProgressIndicator()),
                                errorWidget: (context, url, error) => Icon(Icons.error),
                                fit: BoxFit.fitHeight,
                                filterQuality: FilterQuality.high),
